...
func (c *simpleDidClient) GetDid(ctx context.Context, in *Did, opts ...grpc.CallOption) (*Did, error) {
	...
	out := new(Did)
	err := c.cc.Invoke(ctx, SimpleDid_GetDid_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSimpleDidServer must be embedded to have
...
func (UnimplementedSimpleDidServer) testEmbeddedByValue()                   {}
...
func RegisterSimpleDidServer(s grpc.ServiceRegistrar, srv SimpleDidServer) {
	// If the following call pancis, it indicates UnimplementedSimpleDidServer was
